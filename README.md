...
- I suppose you know you need to have git, docker and docker-compose installed.
...
```
- The second thing you need is your Oxford api keys, so go (https://developer.oxforddictionaries.com) and get your keys.
- Then generate keys for the app
``` bash 
python3 -c 'import secrets; print(secrets.token_hex())'
```
- Time to put everything together. Create .env file in the root of the project with the # The New Project here
I will use this project as a playground to develop skills needed to find a new job
